  ...
  public static Collection<Variable> usedBy(
    ...
    switch (pInstruction.getOpcode()) {
      ...
      case 30: case 31: case 32: case 33:
        usedVariables.add(new VariableImpl(Type.LONG_TYPE));
        break;
      // Handle FLOAD_0 (34), FLOAD_1 (35), FLOAD_2 (36), FLOAD_3 (37)
      case 34: case 35: case 36: case 37:
        usedVariables.add(new VariableImpl(Type.FLOAT_TYPE));
        break;
      // Handle DLOAD_0 (38), DLOAD_1 (39), DLOAD_2 (40), DLOAD_3 (41)
      case 38: case 39: case 40: case 41:
        usedVariables.add(new VariableImpl(Type.DOUBLE_TYPE));
        break;
    ...
    switch (pInstruction.getOpcode()) {
      ...
      case Opcodes.INVOKEINTERFACE:
        ...
        if (returnType != Type.VOID_TYPE) {
          ...
          definedVariables.add(new VariableImpl(returnType));
        }
        break;
